...
namespace HospitalAutomation.Controllers
{
    ...
    public class DistrictController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CityId,Id,Name,PhoneCode")] District district)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CityId"] = new SelectList(_context.City, "Id", "Name", district.CityId);
            return View(district);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,Id,Name,PhoneCode")] District district)
        {
            if (id != district.Id)
            {
                return NotFound();
